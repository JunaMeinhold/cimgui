local t={
  ...
  ImDrawCallback="typedef void (*)(const ImDrawList* parent_list, const ImDrawCmd* cmd);",
  ...
  ImGuiContextHookCallback="typedef void (*)(ImGuiContext* ctx, ImGuiContextHook* hook);",
  ...
  ImGuiDemoMarkerCallback="typedef void (*)(const char* file, int line, const char* section);",
