...
struct ImGuiStyle
{
    float FontSizeBase;
    float FontScaleMain;
    float FontScaleDpi;    float Alpha;
    float DisabledAlpha;
...
{    ImGuiConfigFlags ConfigFlags;
    ...
    ImVec2_c MouseDelta;    ImGuiContext* Ctx;
    ImVec2_c MousePos;
    bool MouseDown[5];
    float MouseWheel;
    float MouseWheelH;
...
struct ImFontAtlas
{
    ...
    int TexMaxWidth;
    int TexMaxHeight;
    void* UserData;    ImTextureRef_c TexRef;    ImTextureData* TexData;
...
struct ImGuiDockNode
{
    ...
    ImGuiAxis SplitAxis;
    ImU32 LastBgColor;
    ImGuiWindowClass WindowClass;    ImGuiWindow* HostWindow;
...
struct ImGuiWindow
{
    ...
    ImVec2_c SetWindowPosPivot;    ImVector_ImGuiID IDStack;
...
struct ImGuiTableTempData
{
    ...
    ImSpan_ImGuiTableColumn OldColumnsData;    ImVec2_c UserOuterSize;
    ImDrawListSplitter DrawSplitter;    ImRect_c HostBackupWorkRect;
    ImRect_c HostBackupParentWorkRect;
